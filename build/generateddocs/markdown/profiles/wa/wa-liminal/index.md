...
Point coordinates are 2D only.

![2D Footprint Example](https://surroundaustralia.github.io/3d-csdm-profile-wa/assets/2d-footprint.png)
...
```json
{
  ...
  "edges": [
    ...
    },
    {
      ...
      "type": "FeatureCollection",
      "featureType": "surv:SubtendedAngle",
      "features": [
        {
          "id": "angle-1",
          "type": "Feature",
...
uuid:55d0e62e-04a9-479c-a98a-1d6e5549a4e2 a geojson:FeatureCollection ;
    geojson:collectionFeatureType "surv:SubtendedAngle" ;
...
Point coordinates are 3D.

This is the same dataset used in the [2D Footprint Example](2d-footprint), except a reference 
surface (ground surface in this instance) has been included.

![2.5D reference surface](https://surroundaustralia.github.io/3d-csdm-profile-wa/assets/2-5d-reference-surface.png)
...
```json
{
  ...
  "id": "03-2-5d-surface",
  "name": "2D footprint bounds a terrain, ground, floor, or reference surface.",
  "description": "Expected validation result for a standard WA cadastral parcel represented by its authoritative 2D footprint with an associated bounded 2.5D terrain, ground, floor, or reference surface. The surface provides vertical context but does not define legal vertical extent or a closed 3D parcel volume.",
  "type": "FeatureCollection",
  "featureType": "3D CSDM",
  "tenureType": "wa-parcel-type:freehold",
  "planType": "wa-survey-type:deposited-plan",
  ...
  "rings": [
    {
      "id": "uuid:36e4faa8-719c-46b0-9062-0d246d98d270",
      "type": "FeatureCollection",
      "featureType": "Ring",
      "features": [
        {
  ...
  "faces": [
    {
      "id": "uuid:a8700ede-3080-4304-929f-d459e193530b",
      "type": "FeatureCollection",
      "featureType": "Face",
      "features": [
        {
...
<file:///github/workspace/03-2-5d-surface> a geojson:FeatureCollection ;
    ...
    topo:faces ( uuid:a8700ede-3080-4304-929f-d459e193530b ) ;
    topo:rings ( uuid:36e4faa8-719c-46b0-9062-0d246d98d270 ) ;
...
uuid:218921de-c36d-4bc9-9116-5045538412be a geojson:FeatureCollection ;
    ...
    geojson:features uuid:ca9c4381-9422-4bbb-8f05-c8a835831933 .

uuid:36e4faa8-719c-46b0-9062-0d246d98d270 a geojson:FeatureCollection ;
    geojson:collectionFeatureType "Ring" ;
    geojson:features uuid:42ca8a19-f8eb-4afc-8aa9-02a99fb6a40b,
...
uuid:a8700ede-3080-4304-929f-d459e193530b a geojson:FeatureCollection ;
    geojson:collectionFeatureType "Face" ;
    geojson:features uuid:785fe569-93c7-4a5a-b8dc-1ed6a4964029,
...
uuid:ae2403ce-5a09-43fb-a89e-fe2832795aa6 a geojson:FeatureCollection ;
    ...
    geojson:features uuid:412069d1-fbd1-4b81-b171-4411b850c3cc .
...
This is the same dataset used in the [2D Footprint Example](2d-footprint), along with a spatial 
representation describing boundary offsets from ground level. A ground surface is not provided
in this example.

![Relative height description](https://surroundaustralia.github.io/3d-csdm-profile-wa/assets/height-described-relative.png)
...
```json
{
  ...
  "id": "04-height-described-relative",
  "name": "Relative height-described parcel.",
  "description": "Expected validation result for a WA cadastral parcel represented by its authoritative 2D footprint with a legal or source-stated relative height or vertical relationship description. The height description is preserved as legal source information but has not been resolved into absolute zMin, zMax, a surface, shell, or 3D solid.",
  "type": "FeatureCollection",
  "featureType": "3D CSDM",
  "tenureType": "wa-parcel-type:freehold",
  "planType": "wa-survey-type:deposited-plan",
  ...
  "has_provenance": [
    ...
    {
      "id": "height-description-extraction-1",
      "activityType": "height-description-extraction",
      "activityName": "Extract relative height description from source plan",
      "used": [
        {
...
Both vertical boundaries are supported by absolute values referenced to the AHD vertical datum 
(EPSG:5711), so `computabilityStatus` is `computable`, but in this example, has not been included in 
the 3D CSDM.

As absolute heights are defined, `zMin` and `zMax` are populated.

![Absolute (AHD) height description](https://surroundaustralia.github.io/3d-csdm-profile-wa/assets/height-defined.png)
...
```json
{
  ...
  "id": "05-height-described-ahd",
  "name": "AHD height-described parcel",
  "description": "Expected validation result for a WA cadastral parcel represented by its authoritative 2D footprint with a legal or source-stated absolute height or depth description expressed against a vertical datum such as AHD. The height description is preserved as legal source information and may populate zMin and/or zMax where supported by the source statement, but no shell or 3D solid is defined.",
  "type": "FeatureCollection",
  "featureType": "3D CSDM",
  "tenureType": "wa-parcel-type:freehold",
  "planType": "wa-survey-type:deposited-plan",
  ...
  "has_provenance": [
    ...
    },
    {
      "id": "height-description-extraction-1",
      "activityType": "height-description-extraction",
      "activityName": "Extract absolute height description from source plan",
      "used": [
        {
          "id": "source-plan-dp431276",
          "type": "prov:Entity",
        ...
        {
          "id": "source-height-description-1",
          "type": "prov:Entity",
          "role": "sourceHeightDescription"
        },
        {
          "id": "source-height-description-2",
          "type": "prov:Entity",
          "role": "sourceHeightDescription"
        }
      ],
      "generated": [
        {
          "id": "parcel-1/absoluteHeightDescription",
          "type": "prov:Entity",
          "role": "normalisedAbsoluteHeightDescription"
        }
      ],
      "wasAssociatedWith": [
        {
  ...
  "annotations": [
    ...
    {
      "description": "Survey carried out under Regulation 4 Compiled Plan of Transfer of Land (Surveys) Regulations 1955",
      "href": "wa_leg:Transfer%20of%20Land%20(Surveys)%20Regulations%201955%20-%20%5B01-b0-09%5D.pdf",
      "role": "wa-annotation-role:r-4"
    },
    {
      "id": "source-height-description-dp431276-lot800",
      ...
      "definesVerticalBoundaries": [
        {
          "definitionRef": "relative-limit-lower-1",
          "limitRole": "vertical-limit-role:ll",
          "sourceStatement": "limited in height to more than and equal to 16.00 AHD"
        },
        {
          "definitionRef": "relative-limit-upper-1",
          "limitRole": "vertical-limit-role:ul",
          "sourceStatement": "limited in height to less than and equal to 35.00 AHD"
        }
      ]
    }
  ]
...
### Jurisdictionally bounded height description
Similar to **Relative Height Description** above. However, the vertical boundary is established by title, 
Crown Grant, statute or by another jurisdictional authority, as opposed to _by survey_ in the **Relative 
Height Description** example.

In this example only a lower vertical extent is defined (commonly resulting from a WA Crown Grant).

![Jurisdictionally bounded height description](https://surroundaustralia.github.io/3d-csdm-profile-wa/assets/jurisdictionally-bounded.png)
...
```json
{
  ...
  "id": "06-jurisdictionally-bounded",
  "name": "Jurisdictionally bounded parcel",
  "description": "Expected validation result for a WA cadastral parcel represented by its authoritative 2D footprint with upper or lower vertical limits defined by an explicit title, plan, statute, Crown Grant condition, strata statement, or approved jurisdictional rule. The jurisdictional source rule and source wording are preserved and traceable. zMin and zMax are populated only where the rule is computable; no jurisdictional limit is applied silently.",
  "type": "FeatureCollection",
  "featureType": "3D CSDM",
  "tenureType": "wa-parcel-type:freehold",
  "planType": "wa-survey-type:deposited-plan",
  ...
  "supportingDocuments": [
    ...
    {
      "title": "Certificate of Title for Lot 800",
      "href": "https://wa.gov.au/ct/ct-2500-585.pdf",
      "role": "wa-survey-documentation-type:ct",
      "rel": "related"
    }
  ],
  "annotations": [
    ...
    {
      "id": "source-height-description-dp431276-lot800",
      "description": "Lot 800 is limited in depth to 12.19 metres below ground level.",
      "role": "wa-annotation-role:height-limit-description",
      "sourceAuthorityType": "wa-survey-type:ct",
      "sourceLocation": {
        "page": 4,
        "section": "CT encumbrances",
        "lot": "Lot 800"
      },
      "transcriptionStatus": "transcribed",
      "appliesTo": "parcel-1",
      "definesVerticalBoundaries": [
        {
          "definitionRef": "relative-limit-lower-1",
          "limitRole": "vertical-limit-role:ll",
          "sourceStatement": "limited in depth to 12.19 metres below ground level"
        }
      ]
    }
  ]
...
```json
{
  ...
  "rings": [
    {
      ...
      "features": [
        ...
        {
          "id": "uuid:a7af8b94-f9af-43ba-9f61-92f7e23c5d7d",
          "type": "Feature",
          "geometry": null,
          "topology": {
            "type": "Ring",
  ...
  "terrain_intersection_curve": [
    {
      "id": "uuid:951164d0-0321-446a-b8fd-15a042725da6",
      "type": "FeatureCollection",
      "featureType": "terrainIntersectionCurve",
      "features": [
        {
          "id": "uuid:c2a267e3-84d9-4dc9-9084-8c3013f234bf",
          "properties": {
            "groundSurfaceRef": "uuid:ca9c4381-9422-4bbb-8f05-c8a835831933",
            "solidRef": "uuid:fbefade9-9cda-4826-9327-3ba8796191f5",
            "ringRef": "uuid:a7af8b94-f9af-43ba-9f61-92f7e23c5d7d"
          }
        }
      ]
    }
...
uuid:a7af8b94-f9af-43ba-9f61-92f7e23c5d7d a geojson:Feature ;
    geojson:topology [ a topo:Ring ;
            topo:directedReferences ( [ topo:orientation "-" ;
                        ...
                        topo:ref <file:///github/workspace/line-geometry-4> ] ) ] .
...
uuid:b4ab3483-688b-4b11-9d5b-5624939ef7a5 a geojson:FeatureCollection ;
    ...
    geojson:features uuid:0108c7f2-75d9-4a14-8028-b7044816eeec,
        ...
        uuid:a7af8b94-f9af-43ba-9f61-92f7e23c5d7d,
...
<https://www.wa-example.com/features/213> a geojson:Feature,
    ...
    parcel:appellation [ a <wa:LotOnPlanAppellation> ;
            ...
            dcterms:hasPart [ rdfs:label "213" ;
